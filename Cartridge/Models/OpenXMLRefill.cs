...
{
    public class OpenXMLRefill
    {// Creates a WordprocessingDocument.
        b1cakEntities db = new b1cakEntities();

        public void CreatePackage(string filePath, List<ModelCounter> listModelCounter)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document))
            {
                CreateParts(package, listModelCounter);
            }
        }
        public byte[] CreatePackageAsBytes(List<ModelCounter> listModelCounter)
        {
        ...
        private void CreateParts(WordprocessingDocument document, List<ModelCounter> listModelCounter)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, listModelCounter);
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "484";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, List<ModelCounter> listModelCounter)
        {
            ModelCounter[] massiveModelCounter = new ModelCounter[15];//Создаем массив
            p000049 voidModel = new p000049()//Создаем объект для заполнения массива пустыми значенияи
            {
                cartridge_brand = "",
                cartridge_model = ""
            };
            ...
            }//заполняем массив данными из списка+пустыми значениями
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00F2328A", RsidParagraphAddition = "000C786F", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00F2328A" };
            ...
            Run run1 = new Run() { RsidRunProperties = "00F2328A" };
            ...
            Text text1 = new Text();
            text1.Text = "Ведомость выдачи картриджей на заправку";
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00F2328A" };
            ...
            Run run3 = new Run() { RsidRunProperties = "00F2328A" };
            ...
            Text text3 = new Text();
            text3.Text = "огласно договора №168 от 18.03.2016";
            ...
            GridColumn gridColumn1 = new GridColumn() { Width = "6941" };
            GridColumn gridColumn2 = new GridColumn() { Width = "2404" };

            tableGrid1.Append(gridColumn1);
            tableGrid1.Append(gridColumn2);

            TableRow tableRow1 = new TableRow() { RsidTableRowAddition = "00F2328A", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell1 = new TableCell();

            TableCellProperties tableCellProperties1 = new TableCellProperties();
            TableCellWidth tableCellWidth1 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties1.Append(tableCellWidth1);

            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00F2328A", RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00F2328A" };
            ...
            Run run4 = new Run() { RsidRunProperties = "00F2328A" };
            ...
            Text text4 = new Text();
            text4.Text = "Наименование модели картриджа";
            ...
            TableCellWidth tableCellWidth2 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties2.Append(tableCellWidth2);

            Paragraph paragraph4 = new Paragraph() { RsidParagraphMarkRevision = "00F2328A", RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00F2328A" };
            ...
            Run run5 = new Run() { RsidRunProperties = "00F2328A" };
            ...
            TableRow tableRow2 = new TableRow() { RsidTableRowAddition = "00F2328A", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell3 = new TableCell();

            TableCellProperties tableCellProperties3 = new TableCellProperties();
            TableCellWidth tableCellWidth3 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties3.Append(tableCellWidth3);

            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00EE17D9" };
            ...
            Text text6 = new Text();
            text6.Text = massiveModelCounter[0].Model.cartridge_brand.ToString() + " " + massiveModelCounter[0].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth4 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties4.Append(tableCellWidth4);

            Paragraph paragraph6 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "003F5E92", RsidRunAdditionDefault = "00EE17D9" };
            ...
            Text text7 = new Text();
            if (massiveModelCounter[0].Count != 0)
                text7.Text = massiveModelCounter[0].Count.ToString();
            else
                text7.Text = "";
            ...
            TableRow tableRow3 = new TableRow() { RsidTableRowAddition = "00F2328A", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell5 = new TableCell();

            TableCellProperties tableCellProperties5 = new TableCellProperties();
            TableCellWidth tableCellWidth5 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties5.Append(tableCellWidth5);

            Paragraph paragraph7 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00EE17D9" };
            ...
            Text text8 = new Text();
            text8.Text = massiveModelCounter[1].Model.cartridge_brand.ToString() + " " + massiveModelCounter[1].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth6 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties6.Append(tableCellWidth6);

            Paragraph paragraph8 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "003F5E92", RsidRunAdditionDefault = "00EE17D9" };
            ...
            Text text9 = new Text();
            if (massiveModelCounter[1].Count != 0)
                text9.Text = massiveModelCounter[1].Count.ToString();
            else
                text9.Text = "";
            ...
            Run run10 = new Run() { RsidRunAddition = "00F2328A" };
            ...
            run10.Append(fieldChar1);

            Run run11 = new Run() { RsidRunAddition = "00F2328A" };
            ...
            fieldCode1.Text = " MERGEFIELD  <field1> ";

            run11.Append(runProperties11);
            run11.Append(fieldCode1);

            Run run12 = new Run() { RsidRunAddition = "00F2328A" };
            ...
            TableRow tableRow4 = new TableRow() { RsidTableRowAddition = "00F2328A", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell7 = new TableCell();

            TableCellProperties tableCellProperties7 = new TableCellProperties();
            TableCellWidth tableCellWidth7 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties7.Append(tableCellWidth7);

            Paragraph paragraph9 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00EE17D9" };
            ...
            text10.Text = massiveModelCounter[2].Model.cartridge_brand.ToString() + " " + massiveModelCounter[2].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth8 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties8.Append(tableCellWidth8);

            Paragraph paragraph10 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties14.Append(noProof6);
            runProperties14.Append(fontSize24);
            runProperties14.Append(fontSizeComplexScript24);
            Text text11 = new Text();
            if (massiveModelCounter[2].Count != 0)
                text11.Text = massiveModelCounter[2].Count.ToString();
            else
                text11.Text = "";
            ...
            TableRow tableRow5 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell9 = new TableCell();

            TableCellProperties tableCellProperties9 = new TableCellProperties();
            TableCellWidth tableCellWidth9 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties9.Append(tableCellWidth9);

            Paragraph paragraph11 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            text12.Text = massiveModelCounter[3].Model.cartridge_brand.ToString() + " " + massiveModelCounter[3].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth10 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties10.Append(tableCellWidth10);

            Paragraph paragraph12 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties16.Append(noProof8);
            runProperties16.Append(fontSize28);
            runProperties16.Append(fontSizeComplexScript28);
            Text text13 = new Text();
            if (massiveModelCounter[3].Count != 0)
                text13.Text = massiveModelCounter[3].Count.ToString();
            else
                text13.Text = "";
            ...
            TableRow tableRow6 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell11 = new TableCell();

            TableCellProperties tableCellProperties11 = new TableCellProperties();
            TableCellWidth tableCellWidth11 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties11.Append(tableCellWidth11);

            Paragraph paragraph13 = new Paragraph() { RsidParagraphMarkRevision = "00EE17D9", RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties13.Append(languages1);
            ...
            text14.Text = massiveModelCounter[4].Model.cartridge_brand.ToString() + " " + massiveModelCounter[4].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth12 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties12.Append(tableCellWidth12);

            Paragraph paragraph14 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties18.Append(noProof10);
            runProperties18.Append(fontSize32);
            runProperties18.Append(fontSizeComplexScript32);
            Text text15 = new Text();
            if (massiveModelCounter[4].Count != 0)
                text15.Text = massiveModelCounter[4].Count.ToString();
            else
                text15.Text = "";
            ...
            TableRow tableRow7 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell13 = new TableCell();

            TableCellProperties tableCellProperties13 = new TableCellProperties();
            TableCellWidth tableCellWidth13 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties13.Append(tableCellWidth13);

            Paragraph paragraph15 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties19.Append(noProof11);
            runProperties19.Append(fontSize34);
            runProperties19.Append(fontSizeComplexScript34);
            Text text16 = new Text();
            text16.Text = massiveModelCounter[5].Model.cartridge_brand.ToString() + " " + massiveModelCounter[5].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth14 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties14.Append(tableCellWidth14);

            Paragraph paragraph16 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties20.Append(noProof12);
            runProperties20.Append(fontSize36);
            runProperties20.Append(fontSizeComplexScript36);
            Text text17 = new Text();
            if (massiveModelCounter[5].Count != 0)
                text17.Text = massiveModelCounter[5].Count.ToString();
            else
                text17.Text = "";
            ...
            TableRow tableRow8 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell15 = new TableCell();

            TableCellProperties tableCellProperties15 = new TableCellProperties();
            TableCellWidth tableCellWidth15 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties15.Append(tableCellWidth15);

            Paragraph paragraph17 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties21.Append(noProof13);
            runProperties21.Append(fontSize38);
            runProperties21.Append(fontSizeComplexScript38);
            Text text18 = new Text();
            text18.Text = massiveModelCounter[6].Model.cartridge_brand.ToString() + " " + massiveModelCounter[6].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth16 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties16.Append(tableCellWidth16);

            Paragraph paragraph18 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties22.Append(noProof14);
            runProperties22.Append(fontSize40);
            runProperties22.Append(fontSizeComplexScript40);
            Text text19 = new Text();
            if (massiveModelCounter[6].Count != 0)
                text19.Text = massiveModelCounter[6].Count.ToString();
            else
                text19.Text = "";
            ...
            TableRow tableRow9 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell17 = new TableCell();

            TableCellProperties tableCellProperties17 = new TableCellProperties();
            TableCellWidth tableCellWidth17 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties17.Append(tableCellWidth17);

            Paragraph paragraph19 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "00EE17D9", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties23.Append(fontSize42);
            runProperties23.Append(fontSizeComplexScript42);
            Text text20 = new Text();
            text20.Text = massiveModelCounter[7].Model.cartridge_brand.ToString() + " " + massiveModelCounter[7].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth18 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties18.Append(tableCellWidth18);

            Paragraph paragraph20 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties20.Append(fontSize43);
            ...
            runProperties24.Append(fontSize44);
            runProperties24.Append(fontSizeComplexScript44);
            Text text21 = new Text();
            if (massiveModelCounter[7].Count != 0)
                text21.Text = massiveModelCounter[7].Count.ToString();
            else
                text21.Text = "";
            ...
            TableRow tableRow10 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell19 = new TableCell();

            TableCellProperties tableCellProperties19 = new TableCellProperties();
            TableCellWidth tableCellWidth19 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties19.Append(tableCellWidth19);

            Paragraph paragraph21 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties21.Append(runFonts45);
            paragraphMarkRunProperties21.Append(fontSize45);
            paragraphMarkRunProperties21.Append(fontSizeComplexScript45);
            ...
            runProperties25.Append(fontSize46);
            runProperties25.Append(fontSizeComplexScript46);
            Text text22 = new Text();
            text22.Text = massiveModelCounter[8].Model.cartridge_brand.ToString() + " " + massiveModelCounter[8].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth20 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties20.Append(tableCellWidth20);

            Paragraph paragraph22 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties22.Append(runFonts47);
            paragraphMarkRunProperties22.Append(fontSize47);
            paragraphMarkRunProperties22.Append(fontSizeComplexScript47);
            ...
            runProperties26.Append(runFonts48);
            runProperties26.Append(noProof18);
            runProperties26.Append(fontSize48);
            runProperties26.Append(fontSizeComplexScript48);
            Text text23 = new Text();
            if (massiveModelCounter[8].Count != 0)
                text23.Text = massiveModelCounter[8].Count.ToString();
            else
                text23.Text = "";
            ...
            TableRow tableRow11 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell21 = new TableCell();

            TableCellProperties tableCellProperties21 = new TableCellProperties();
            TableCellWidth tableCellWidth21 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties21.Append(tableCellWidth21);

            Paragraph paragraph23 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties23.Append(runFonts49);
            paragraphMarkRunProperties23.Append(fontSize49);
            paragraphMarkRunProperties23.Append(fontSizeComplexScript49);
            ...
            runProperties27.Append(runFonts50);
            runProperties27.Append(noProof19);
            runProperties27.Append(fontSize50);
            runProperties27.Append(fontSizeComplexScript50);
            Text text24 = new Text();
            text24.Text = massiveModelCounter[9].Model.cartridge_brand.ToString() + " " + massiveModelCounter[9].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth22 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties22.Append(tableCellWidth22);

            Paragraph paragraph24 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties24.Append(runFonts51);
            paragraphMarkRunProperties24.Append(fontSize51);
            paragraphMarkRunProperties24.Append(fontSizeComplexScript51);
            ...
            runProperties28.Append(runFonts52);
            runProperties28.Append(noProof20);
            runProperties28.Append(fontSize52);
            runProperties28.Append(fontSizeComplexScript52);
            Text text25 = new Text();
            if (massiveModelCounter[9].Count != 0)
                text25.Text = massiveModelCounter[9].Count.ToString();
            else
                text25.Text = "";
            ...
            TableRow tableRow12 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell23 = new TableCell();

            TableCellProperties tableCellProperties23 = new TableCellProperties();
            TableCellWidth tableCellWidth23 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties23.Append(tableCellWidth23);

            Paragraph paragraph25 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties25.Append(runFonts53);
            paragraphMarkRunProperties25.Append(fontSize53);
            paragraphMarkRunProperties25.Append(fontSizeComplexScript53);
            ...
            runProperties29.Append(noProof21);
            runProperties29.Append(fontSize54);
            runProperties29.Append(fontSizeComplexScript54);
            Text text26 = new Text();
            text26.Text = massiveModelCounter[10].Model.cartridge_brand.ToString() + " " + massiveModelCounter[10].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth24 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties24.Append(tableCellWidth24);

            Paragraph paragraph26 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties26.Append(runFonts55);
            paragraphMarkRunProperties26.Append(fontSize55);
            paragraphMarkRunProperties26.Append(fontSizeComplexScript55);
            ...
            runProperties30.Append(runFonts56);
            runProperties30.Append(noProof22);
            runProperties30.Append(fontSize56);
            runProperties30.Append(fontSizeComplexScript56);
            Text text27 = new Text();
            if (massiveModelCounter[10].Count != 0)
                text27.Text = massiveModelCounter[10].Count.ToString();
            else
                text27.Text = "";
            ...
            TableRow tableRow13 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell25 = new TableCell();

            TableCellProperties tableCellProperties25 = new TableCellProperties();
            TableCellWidth tableCellWidth25 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties25.Append(tableCellWidth25);

            Paragraph paragraph27 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties31.Append(runFonts58);
            runProperties31.Append(noProof23);
            runProperties31.Append(fontSize58);
            runProperties31.Append(fontSizeComplexScript58);
            Text text28 = new Text();
            text28.Text = massiveModelCounter[11].Model.cartridge_brand.ToString() + " " + massiveModelCounter[11].Model.cartridge_model.ToString();
            ...
            TableCellWidth tableCellWidth26 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties26.Append(tableCellWidth26);

            Paragraph paragraph28 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties28.Append(runFonts59);
            paragraphMarkRunProperties28.Append(fontSize59);
            paragraphMarkRunProperties28.Append(fontSizeComplexScript59);
            ...
            runProperties32.Append(runFonts60);
            runProperties32.Append(noProof24);
            runProperties32.Append(fontSize60);
            runProperties32.Append(fontSizeComplexScript60);
            Text text29 = new Text();
            if (massiveModelCounter[11].Count != 0)
                text29.Text = massiveModelCounter[11].Count.ToString();
            else
                text29.Text = "";
            ...
            TableRow tableRow14 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell27 = new TableCell();

            TableCellProperties tableCellProperties27 = new TableCellProperties();
            TableCellWidth tableCellWidth27 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties27.Append(tableCellWidth27);

            Paragraph paragraph29 = new Paragraph() { RsidParagraphMarkRevision = "00EE17D9", RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "00EE17D9", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties29.Append(languages2);
            ...
            runProperties33.Append(runFonts62);
            runProperties33.Append(noProof25);
            runProperties33.Append(fontSize62);
            runProperties33.Append(fontSizeComplexScript62);
            Text text30 = new Text();
            text30.Text = massiveModelCounter[12].Model.cartridge_brand.ToString() + " " + massiveModelCounter[12].Model.cartridge_model.ToString();
            ...
            runProperties34.Append(runFonts63);
            runProperties34.Append(noProof26);
            runProperties34.Append(fontSize63);
            runProperties34.Append(fontSizeComplexScript63);
            runProperties34.Append(languages3);
            ...
            TableCellWidth tableCellWidth28 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties28.Append(tableCellWidth28);

            Paragraph paragraph30 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            runProperties35.Append(runFonts65);
            runProperties35.Append(noProof27);
            runProperties35.Append(fontSize65);
            runProperties35.Append(fontSizeComplexScript65);
            Text text32 = new Text();
            if (massiveModelCounter[12].Count != 0)
                text32.Text = massiveModelCounter[12].Count.ToString();
            else
                text32.Text = "";
            ...
            TableRow tableRow15 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell29 = new TableCell();

            TableCellProperties tableCellProperties29 = new TableCellProperties();
            TableCellWidth tableCellWidth29 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties29.Append(tableCellWidth29);

            Paragraph paragraph31 = new Paragraph() { RsidParagraphMarkRevision = "00EE17D9", RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "00EE17D9", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties31.Append(languages4);
            ...
            runProperties36.Append(runFonts67);
            runProperties36.Append(noProof28);
            runProperties36.Append(fontSize67);
            runProperties36.Append(fontSizeComplexScript67);
            Text text33 = new Text();
            text33.Text = massiveModelCounter[13].Model.cartridge_brand.ToString() + " " + massiveModelCounter[13].Model.cartridge_model.ToString();
            ...
            runProperties37.Append(runFonts68);
            runProperties37.Append(noProof29);
            runProperties37.Append(fontSize68);
            runProperties37.Append(fontSizeComplexScript68);
            runProperties37.Append(languages5);
            ...
            TableCellWidth tableCellWidth30 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties30.Append(tableCellWidth30);

            Paragraph paragraph32 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties32.Append(runFonts69);
            paragraphMarkRunProperties32.Append(fontSize69);
            paragraphMarkRunProperties32.Append(fontSizeComplexScript69);
            ...
            runProperties38.Append(runFonts70);
            runProperties38.Append(noProof30);
            runProperties38.Append(fontSize70);
            runProperties38.Append(fontSizeComplexScript70);
            Text text35 = new Text();
            if (massiveModelCounter[13].Count != 0)
                text35.Text = massiveModelCounter[13].Count.ToString();
            else
                text35.Text = "";
            ...
            TableRow tableRow16 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell31 = new TableCell();

            TableCellProperties tableCellProperties31 = new TableCellProperties();
            TableCellWidth tableCellWidth31 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties31.Append(tableCellWidth31);

            Paragraph paragraph33 = new Paragraph() { RsidParagraphMarkRevision = "00EE17D9", RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "00EE17D9", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties33.Append(fontSize71);
            paragraphMarkRunProperties33.Append(fontSizeComplexScript71);
            paragraphMarkRunProperties33.Append(languages6);
            ...
            runProperties39.Append(runFonts72);
            runProperties39.Append(noProof31);
            runProperties39.Append(fontSize72);
            runProperties39.Append(fontSizeComplexScript72);
            Text text36 = new Text();
            text36.Text = massiveModelCounter[14].Model.cartridge_brand.ToString() + " " + massiveModelCounter[14].Model.cartridge_model.ToString();
            ...
            paragraph33.Append(run39);
            paragraph33.Append(run40);
            ...
            TableCellWidth tableCellWidth32 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties32.Append(tableCellWidth32);

            Paragraph paragraph34 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties34.Append(fontSizeComplexScript74);
            ...
            runProperties41.Append(noProof33);
            runProperties41.Append(fontSize75);
            runProperties41.Append(fontSizeComplexScript75);
            Text text38 = new Text();
            if (massiveModelCounter[14].Count != 0)
                text38.Text = massiveModelCounter[14].Count.ToString();
            else
                text38.Text = "";
            ...
            TableRow tableRow17 = new TableRow() { RsidTableRowAddition = "005C17E3", RsidTableRowProperties = "00F2328A" };

            TableCell tableCell33 = new TableCell();

            TableCellProperties tableCellProperties33 = new TableCellProperties();
            TableCellWidth tableCellWidth33 = new TableCellWidth() { Width = "6941", Type = TableWidthUnitValues.Dxa };

            tableCellProperties33.Append(tableCellWidth33);

            Paragraph paragraph35 = new Paragraph() { RsidParagraphMarkRevision = "003F5E92", RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "005C17E3" };
            ...
            paragraphMarkRunProperties35.Append(runFonts76);
            paragraphMarkRunProperties35.Append(fontSize76);
            paragraphMarkRunProperties35.Append(fontSizeComplexScript76);
            ...
            TableCellWidth tableCellWidth34 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };

            tableCellProperties34.Append(tableCellWidth34);

            Paragraph paragraph36 = new Paragraph() { RsidParagraphAddition = "005C17E3", RsidParagraphProperties = "005C17E3", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties36.Append(runFonts78);
            paragraphMarkRunProperties36.Append(fontSize78);
            paragraphMarkRunProperties36.Append(fontSizeComplexScript78);
            ...
            Paragraph paragraph37 = new Paragraph() { RsidParagraphAddition = "00F2328A", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00F2328A" };
            ...
            paragraphMarkRunProperties37.Append(runFonts80);
            paragraphMarkRunProperties37.Append(fontSize80);
            paragraphMarkRunProperties37.Append(fontSizeComplexScript80);

            paragraphProperties37.Append(paragraphMarkRunProperties37);

            paragraph37.Append(paragraphProperties37);

            Paragraph paragraph38 = new Paragraph() { RsidParagraphAddition = "003F5E92", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "003F5E92" };
            ...
            paragraphMarkRunProperties38.Append(runFonts81);
            paragraphMarkRunProperties38.Append(fontSize81);
            paragraphMarkRunProperties38.Append(fontSizeComplexScript81);
            ...
            GridColumn gridColumn3 = new GridColumn() { Width = "1335" };
            GridColumn gridColumn4 = new GridColumn() { Width = "236" };
            GridColumn gridColumn5 = new GridColumn() { Width = "2434" };
            GridColumn gridColumn6 = new GridColumn() { Width = "243" };
            GridColumn gridColumn7 = new GridColumn() { Width = "2427" };
            GridColumn gridColumn8 = new GridColumn() { Width = "266" };
            GridColumn gridColumn9 = new GridColumn() { Width = "2404" };
            ...
            TableRow tableRow18 = new TableRow() { RsidTableRowAddition = "00993B97", RsidTableRowProperties = "00993B97" };

            TableCell tableCell35 = new TableCell();

            TableCellProperties tableCellProperties35 = new TableCellProperties();
            TableCellWidth tableCellWidth35 = new TableCellWidth() { Width = "1335", Type = TableWidthUnitValues.Dxa };

            tableCellProperties35.Append(tableCellWidth35);

            Paragraph paragraph39 = new Paragraph() { RsidParagraphMarkRevision = "00993B97", RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties39.Append(runFonts82);
            paragraphMarkRunProperties39.Append(fontSize82);
            paragraphMarkRunProperties39.Append(fontSizeComplexScript82);
            ...
            runProperties44.Append(runFonts83);
            runProperties44.Append(fontSize83);
            runProperties44.Append(fontSizeComplexScript83);
            ...
            TableCellWidth tableCellWidth36 = new TableCellWidth() { Width = "236", Type = TableWidthUnitValues.Dxa };

            tableCellProperties36.Append(tableCellWidth36);

            Paragraph paragraph40 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties40.Append(runFonts84);
            paragraphMarkRunProperties40.Append(fontSize84);
            paragraphMarkRunProperties40.Append(fontSizeComplexScript84);
            ...
            TableCellWidth tableCellWidth37 = new TableCellWidth() { Width = "2434", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties37.Append(tableCellBorders1);

            Paragraph paragraph41 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties41.Append(runFonts85);
            paragraphMarkRunProperties41.Append(fontSize85);
            paragraphMarkRunProperties41.Append(fontSizeComplexScript85);
            ...
            TableCellWidth tableCellWidth38 = new TableCellWidth() { Width = "243", Type = TableWidthUnitValues.Dxa };

            tableCellProperties38.Append(tableCellWidth38);

            Paragraph paragraph42 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties42.Append(runFonts86);
            paragraphMarkRunProperties42.Append(fontSize86);
            paragraphMarkRunProperties42.Append(fontSizeComplexScript86);
            ...
            TableCellWidth tableCellWidth39 = new TableCellWidth() { Width = "2427", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties39.Append(tableCellBorders2);

            Paragraph paragraph43 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties43.Append(runFonts87);
            paragraphMarkRunProperties43.Append(fontSize87);
            paragraphMarkRunProperties43.Append(fontSizeComplexScript87);
            ...
            TableCellWidth tableCellWidth40 = new TableCellWidth() { Width = "266", Type = TableWidthUnitValues.Dxa };

            tableCellProperties40.Append(tableCellWidth40);

            Paragraph paragraph44 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties44.Append(fontSize88);
            paragraphMarkRunProperties44.Append(fontSizeComplexScript88);
            ...
            TableCellWidth tableCellWidth41 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties41.Append(tableCellBorders3);

            Paragraph paragraph45 = new Paragraph() { RsidParagraphMarkRevision = "00EE17D9", RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00993B97", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties45.Append(runFonts89);
            paragraphMarkRunProperties45.Append(fontSize89);
            paragraphMarkRunProperties45.Append(fontSizeComplexScript89);
            paragraphMarkRunProperties45.Append(languages8);

            paragraphProperties45.Append(justification5);
            ...
            runProperties45.Append(runFonts90);
            runProperties45.Append(fontSize90);
            runProperties45.Append(fontSizeComplexScript90);
            runProperties45.Append(languages9);
            Text text42 = new Text();
            text42.Text = System.DateTime.Now.ToShortDateString();
            ...
            tableRow18.Append(tableCell36);
            tableRow18.Append(tableCell37);
            tableRow18.Append(tableCell38);
            tableRow18.Append(tableCell39);
            tableRow18.Append(tableCell40);
            tableRow18.Append(tableCell41);

            TableRow tableRow19 = new TableRow() { RsidTableRowAddition = "00993B97", RsidTableRowProperties = "00993B97" };

            TableCell tableCell42 = new TableCell();

            TableCellProperties tableCellProperties42 = new TableCellProperties();
            TableCellWidth tableCellWidth42 = new TableCellWidth() { Width = "1335", Type = TableWidthUnitValues.Dxa };

            tableCellProperties42.Append(tableCellWidth42);

            Paragraph paragraph46 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties46.Append(fontSize91);
            paragraphMarkRunProperties46.Append(fontSizeComplexScript91);
            ...
            TableCellWidth tableCellWidth43 = new TableCellWidth() { Width = "236", Type = TableWidthUnitValues.Dxa };

            tableCellProperties43.Append(tableCellWidth43);

            Paragraph paragraph47 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties47.Append(fontSize92);
            paragraphMarkRunProperties47.Append(fontSizeComplexScript92);
            ...
            TableCellWidth tableCellWidth44 = new TableCellWidth() { Width = "2434", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties44.Append(tableCellBorders4);

            Paragraph paragraph48 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00993B97", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties48.Append(fontSizeComplexScript93);

            paragraphProperties48.Append(justification6);
            ...
            runProperties46.Append(runFonts94);
            runProperties46.Append(fontSize94);
            runProperties46.Append(fontSizeComplexScript94);
            ...
            TableCellWidth tableCellWidth45 = new TableCellWidth() { Width = "243", Type = TableWidthUnitValues.Dxa };

            tableCellProperties45.Append(tableCellWidth45);

            Paragraph paragraph49 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties49.Append(runFonts95);
            paragraphMarkRunProperties49.Append(fontSize95);
            paragraphMarkRunProperties49.Append(fontSizeComplexScript95);
            ...
            TableCellWidth tableCellWidth46 = new TableCellWidth() { Width = "2427", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties46.Append(tableCellBorders5);

            Paragraph paragraph50 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00993B97", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties50.Append(runFonts96);
            paragraphMarkRunProperties50.Append(fontSize96);
            paragraphMarkRunProperties50.Append(fontSizeComplexScript96);

            paragraphProperties50.Append(justification7);
            ...
            runProperties47.Append(runFonts97);
            runProperties47.Append(fontSize97);
            runProperties47.Append(fontSizeComplexScript97);
            ...
            TableCellWidth tableCellWidth47 = new TableCellWidth() { Width = "266", Type = TableWidthUnitValues.Dxa };

            tableCellProperties47.Append(tableCellWidth47);

            Paragraph paragraph51 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties51.Append(runFonts98);
            paragraphMarkRunProperties51.Append(fontSize98);
            paragraphMarkRunProperties51.Append(fontSizeComplexScript98);
            ...
            TableCellWidth tableCellWidth48 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellBorders6.Append(topBorder4);

            tableCellProperties48.Append(tableCellWidth48);
            tableCellProperties48.Append(tableCellBorders6);

            Paragraph paragraph52 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00993B97", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties52.Append(fontSizeComplexScript99);

            paragraphProperties52.Append(justification8);
            ...
            runProperties48.Append(fontSizeComplexScript100);
            ...
            tableRow19.Append(tableCell44);
            tableRow19.Append(tableCell45);
            tableRow19.Append(tableCell46);
            tableRow19.Append(tableCell47);
            tableRow19.Append(tableCell48);
            ...
            Paragraph paragraph53 = new Paragraph() { RsidParagraphAddition = "003F5E92", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "003F5E92" };
            ...
            paragraphMarkRunProperties53.Append(fontSizeComplexScript101);
            ...
            TableStyle tableStyle3 = new TableStyle() { Val = "a3" };
            ...
            GridColumn gridColumn10 = new GridColumn() { Width = "1335" };
            GridColumn gridColumn11 = new GridColumn() { Width = "236" };
            GridColumn gridColumn12 = new GridColumn() { Width = "2434" };
            GridColumn gridColumn13 = new GridColumn() { Width = "243" };
            GridColumn gridColumn14 = new GridColumn() { Width = "2427" };
            GridColumn gridColumn15 = new GridColumn() { Width = "266" };
            GridColumn gridColumn16 = new GridColumn() { Width = "2404" };
            ...
            TableRow tableRow20 = new TableRow() { RsidTableRowAddition = "00993B97", RsidTableRowProperties = "00BC253A" };

            TableCell tableCell49 = new TableCell();

            TableCellProperties tableCellProperties49 = new TableCellProperties();
            TableCellWidth tableCellWidth49 = new TableCellWidth() { Width = "1335", Type = TableWidthUnitValues.Dxa };

            tableCellProperties49.Append(tableCellWidth49);

            Paragraph paragraph54 = new Paragraph() { RsidParagraphMarkRevision = "00993B97", RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties54.Append(fontSizeComplexScript102);
            ...
            runProperties49.Append(fontSizeComplexScript103);
            ...
            TableCellWidth tableCellWidth50 = new TableCellWidth() { Width = "236", Type = TableWidthUnitValues.Dxa };

            tableCellProperties50.Append(tableCellWidth50);

            Paragraph paragraph55 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties55.Append(fontSizeComplexScript104);
            ...
            TableCellWidth tableCellWidth51 = new TableCellWidth() { Width = "2434", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellBorders7.Append(bottomBorder6);

            tableCellProperties51.Append(tableCellWidth51);
            tableCellProperties51.Append(tableCellBorders7);

            Paragraph paragraph56 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties56.Append(runFonts105);
            paragraphMarkRunProperties56.Append(fontSize105);
            paragraphMarkRunProperties56.Append(fontSizeComplexScript105);
            ...
            TableCellWidth tableCellWidth52 = new TableCellWidth() { Width = "243", Type = TableWidthUnitValues.Dxa };

            tableCellProperties52.Append(tableCellWidth52);

            Paragraph paragraph57 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties57.Append(runFonts106);
            paragraphMarkRunProperties57.Append(fontSize106);
            paragraphMarkRunProperties57.Append(fontSizeComplexScript106);
            ...
            TableCellWidth tableCellWidth53 = new TableCellWidth() { Width = "2427", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties53.Append(tableCellBorders8);

            Paragraph paragraph58 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties58.Append(runFonts107);
            paragraphMarkRunProperties58.Append(fontSize107);
            paragraphMarkRunProperties58.Append(fontSizeComplexScript107);
            ...
            TableCellWidth tableCellWidth54 = new TableCellWidth() { Width = "266", Type = TableWidthUnitValues.Dxa };

            tableCellProperties54.Append(tableCellWidth54);

            Paragraph paragraph59 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties59.Append(runFonts108);
            paragraphMarkRunProperties59.Append(fontSize108);
            paragraphMarkRunProperties59.Append(fontSizeComplexScript108);
            ...
            TableCellWidth tableCellWidth55 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties55.Append(tableCellBorders9);

            Paragraph paragraph60 = new Paragraph() { RsidParagraphMarkRevision = "00EE17D9", RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00993B97", RsidRunAdditionDefault = "00EE17D9" };
            ...
            paragraphMarkRunProperties60.Append(runFonts109);
            paragraphMarkRunProperties60.Append(fontSize109);
            paragraphMarkRunProperties60.Append(fontSizeComplexScript109);
            paragraphMarkRunProperties60.Append(languages10);

            paragraphProperties60.Append(justification9);
            ...
            runProperties50.Append(runFonts110);
            runProperties50.Append(fontSize110);
            runProperties50.Append(fontSizeComplexScript110);
            runProperties50.Append(languages11);
            ...
            paragraph60.Append(run50);
            paragraph60.Append(bookmarkStart1);
            paragraph60.Append(bookmarkEnd1);

            tableCell55.Append(tableCellProperties55);
            tableCell55.Append(paragraph60);

            tableRow20.Append(tableCell49);
            tableRow20.Append(tableCell50);
            tableRow20.Append(tableCell51);
            tableRow20.Append(tableCell52);
            tableRow20.Append(tableCell53);
            tableRow20.Append(tableCell54);
            tableRow20.Append(tableCell55);

            TableRow tableRow21 = new TableRow() { RsidTableRowAddition = "00993B97", RsidTableRowProperties = "00BC253A" };

            TableCell tableCell56 = new TableCell();

            TableCellProperties tableCellProperties56 = new TableCellProperties();
            TableCellWidth tableCellWidth56 = new TableCellWidth() { Width = "1335", Type = TableWidthUnitValues.Dxa };

            tableCellProperties56.Append(tableCellWidth56);

            Paragraph paragraph61 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties61.Append(runFonts111);
            paragraphMarkRunProperties61.Append(fontSize111);
            paragraphMarkRunProperties61.Append(fontSizeComplexScript111);
            ...
            Paragraph paragraph62 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties62.Append(runFonts112);
            paragraphMarkRunProperties62.Append(fontSize112);
            paragraphMarkRunProperties62.Append(fontSizeComplexScript112);
            ...
            TableCellWidth tableCellWidth58 = new TableCellWidth() { Width = "2434", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties58.Append(tableCellBorders10);

            Paragraph paragraph63 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties63.Append(runFonts113);
            paragraphMarkRunProperties63.Append(fontSize113);
            paragraphMarkRunProperties63.Append(fontSizeComplexScript113);

            paragraphProperties63.Append(justification10);
            ...
            runProperties51.Append(runFonts114);
            runProperties51.Append(fontSize114);
            runProperties51.Append(fontSizeComplexScript114);
            ...
            TableCellWidth tableCellWidth59 = new TableCellWidth() { Width = "243", Type = TableWidthUnitValues.Dxa };

            tableCellProperties59.Append(tableCellWidth59);

            Paragraph paragraph64 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties64.Append(runFonts115);
            paragraphMarkRunProperties64.Append(fontSize115);
            paragraphMarkRunProperties64.Append(fontSizeComplexScript115);
            ...
            TableCellWidth tableCellWidth60 = new TableCellWidth() { Width = "2427", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties60.Append(tableCellBorders11);

            Paragraph paragraph65 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties65.Append(runFonts116);
            paragraphMarkRunProperties65.Append(fontSize116);
            paragraphMarkRunProperties65.Append(fontSizeComplexScript116);

            paragraphProperties65.Append(justification11);
            ...
            runProperties52.Append(runFonts117);
            runProperties52.Append(fontSize117);
            runProperties52.Append(fontSizeComplexScript117);
            ...
            TableCellWidth tableCellWidth61 = new TableCellWidth() { Width = "266", Type = TableWidthUnitValues.Dxa };

            tableCellProperties61.Append(tableCellWidth61);

            Paragraph paragraph66 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties66.Append(runFonts118);
            paragraphMarkRunProperties66.Append(fontSize118);
            ...
            TableCellWidth tableCellWidth62 = new TableCellWidth() { Width = "2404", Type = TableWidthUnitValues.Dxa };
            ...
            tableCellProperties62.Append(tableCellBorders12);

            Paragraph paragraph67 = new Paragraph() { RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00BC253A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties67.Append(runFonts119);
            paragraphMarkRunProperties67.Append(fontSize119);
            paragraphMarkRunProperties67.Append(fontSizeComplexScript119);

            paragraphProperties67.Append(justification12);
            ...
            runProperties53.Append(runFonts120);
            runProperties53.Append(fontSize120);
            runProperties53.Append(fontSizeComplexScript120);
            ...
            paragraph67.Append(run53);

            tableCell62.Append(tableCellProperties62);
            tableCell62.Append(paragraph67);

            tableRow21.Append(tableCell56);
            tableRow21.Append(tableCell57);
            tableRow21.Append(tableCell58);
            tableRow21.Append(tableCell59);
            tableRow21.Append(tableCell60);
            ...
            Paragraph paragraph68 = new Paragraph() { RsidParagraphMarkRevision = "00F2328A", RsidParagraphAddition = "00993B97", RsidParagraphProperties = "00F2328A", RsidRunAdditionDefault = "00993B97" };
            ...
            paragraphMarkRunProperties68.Append(runFonts121);
            paragraphMarkRunProperties68.Append(fontSize121);
            paragraphMarkRunProperties68.Append(fontSizeComplexScript121);

            paragraphProperties68.Append(paragraphMarkRunProperties68);

            paragraph68.Append(paragraphProperties68);

            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00F2328A", RsidR = "00993B97" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00487707" };
            Rsid rsid1 = new Rsid() { Val = "000C786F" };
            Rsid rsid2 = new Rsid() { Val = "001054C3" };
            Rsid rsid3 = new Rsid() { Val = "003F5E92" };
            Rsid rsid4 = new Rsid() { Val = "00487707" };
            Rsid rsid5 = new Rsid() { Val = "005C17E3" };
            Rsid rsid6 = new Rsid() { Val = "00863AE7" };
            Rsid rsid7 = new Rsid() { Val = "00993B97" };
            Rsid rsid8 = new Rsid() { Val = "00A70182" };
            Rsid rsid9 = new Rsid() { Val = "00EE17D9" };
            Rsid rsid10 = new Rsid() { Val = "00F2328A" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "44E65829" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<w15:docId w15:val=\"{BA273384-D31B-4CB2-8ECF-8CA5E6EA51FF}\" xmlns:w15=\"http://schemas.microsoft.com/office/word/2012/wordml\" />");
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts122 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            FontSize fontSize122 = new FontSize() { Val = "22" };
            FontSizeComplexScript fontSizeComplexScript122 = new FontSizeComplexScript() { Val = "22" };
            Languages languages12 = new Languages() { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };

            runPropertiesBaseStyle1.Append(runFonts122);
            runPropertiesBaseStyle1.Append(fontSize122);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript122);
            ...
            Rsid rsid11 = new Rsid() { Val = "00F2328A" };
            ...
            tableBorders3.Append(topBorder9);
            tableBorders3.Append(leftBorder3);
            tableBorders3.Append(bottomBorder9);
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Revision = "11";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2018-01-04T10:11:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2018-01-19T07:50:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
